  ...
  return (
    <div className="max-w-sm mx-auto px-6 py-24 text-center">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 px-5 py-3 border border-wire rounded-lg bg-surface text-ink text-sm font-sans font-medium hover:border-accent transition-colors"
      >
